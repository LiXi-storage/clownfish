...
def service_move_usage(log):
    ...
    """
    log.cl_stdout("""Usage: %s %s <servicename> <hostname>
        servicename: a Lustre service name, e.g. fsname-OST000a""" %
...
def service_argument(connection, complete_status):
    """
...
COMMAND.cc_add_argument(service_argument)
